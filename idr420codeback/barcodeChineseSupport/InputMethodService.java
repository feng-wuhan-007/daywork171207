...
public class InputMethodService extends AbstractInputMethodService {
    ...
    //fengmc add 180116
    private BroadcastReceiver mSe4500Receiver;
    //end
    int mTheme = 0;
	...
	//fengmc add 180115 08:50
	//Log.d(TAG,"inputservicefengmc180116");
	 mSe4500Receiver = new BroadcastReceiver(){
                @Override
                public void onReceive(Context context, Intent intent){
                        ...
                        if(action.equals("com.se4500.onDecodeComplete")){                                                                                                                                   
                                        ...
                                        InputConnection ic = getCurrentInputConnection();
                                        if (ic != null){
                                                ic.commitText(intent.getStringExtra("se4500"),1);
						
                                        }
                                	Intent intentdisp = new Intent("com.se4500.displayok");
	...
	final IntentFilter se4500filter = new IntentFilter();
	se4500filter.addAction("com.se4500.onDecodeComplete");
	registerReceiver(mSe4500Receiver,se4500filter);
	//fengmc end
    }
