...
static jstring iDR_CheckBarcodeType(JNIEnv *e, jobject o)
{
    ...
    //stop BarcodeService
    system("routon_client \"7e8802662e5daf979af0a3a5266bcaa1 /system/bin/am broadcast -a  scanner_service_pause -n  com.routon.barcode/.BarcodeReceiver\"");
	...
	if (fd < 0) {
            ...
            if (ret > 0) {
                ...
                if (len > 0) {
                    ...
                    system("routon_client \"7e8802662e5daf979af0a3a5266bcaa1 /system/bin/am broadcast -a  scanner_service_resume -n  com.routon.barcode/.BarcodeReceiver\"");
